...
def get_fuzzy_system(t, t_min= 5, t_max= 8000, num_sheep_total= 30):
    """
    ...
    d_c = t_max - t         # assuming dog moves one unit per timestep
    ...
    R5 = "IF (Time IS very_large) AND (Distance IS near) AND (Quantity IS small) THEN (Decision IS driving)"
